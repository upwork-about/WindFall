...
const CantoDeposit: React.FC = () => {
  ...
  return <div className="home-deposit">
    <div className="title">
        ...
        return(
          <div key={item.num} className="card-item">
            <div className="top-wrap">
              ...
              <img src="/img/home/cantoDeposit/icon1.png" alt="" />
                <p>CANTO</p>
              </div>
              <div className="right-wrap">
              <span className={item.rightStatus ? '' : 'err'}></span>
              <p >  
  {item.rightStatus ? 'Live' : 'INACTIVE'}  
</p>
              </div>
            </div>
            ...
            <div className="bottom-wrap">
              <div className={`left-wrap ${item.rightStatus ? '' : 'err'}`}>
              {item.btnText}
              </div>
              <div className="right-wrap">
              {item.redText}
